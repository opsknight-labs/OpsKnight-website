...
description: Source-aligned runtime, event, scheduler, notification, and mobile flows for OpsKnight v1.4
---

# Architecture diagrams

These diagrams show the v1.4 implementation boundary. OpsKnight runs the web application and internal scheduler in the same Next.js process model, uses PostgreSQL for durable state, and does not require Redis or a separately deployed worker service.
