...
OpsKnight v1.4 has three distinct webhook systems. Choose the one that matches the direction and ownership of your workflow.
...
There is no service-webhook delivery-history UI or manual replay control in v1.4. Use receiver logs and OpsKnight system logs, then validate fixes with a new controlled event.
