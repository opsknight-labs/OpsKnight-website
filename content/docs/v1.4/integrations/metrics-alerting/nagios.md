...
Send Nagios host and service notifications to an OpsKnight service. Problem, recovery, acknowledgment, downtime, flapping, and custom notification types have distinct v1.4 behavior.
