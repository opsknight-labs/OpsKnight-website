...
- Search visibility follows the current v1.3 query behavior. Do not use the presence or absence of a result as proof of authorization, deletion, or retention.
